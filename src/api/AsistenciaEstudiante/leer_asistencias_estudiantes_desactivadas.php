...
try {
    ...
    $stmt = $asistencia->leerDesactivados();

    echo json_encode(["status" => "success", "message" => "Asistencias de estudiantes desactivadas obtenidas", "data" => $stmt->fetchAll(PDO::FETCH_ASSOC)]);
} catch (Throwable $e) {
